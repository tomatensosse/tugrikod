...
public class Drivetrain extends SubsystemBase {
  ...
  CANCoder canCoderLeftMaster = new CANCoder(0);
  CANCoder canCoderRightMaster = new CANCoder(0);
  ...
  */
  ...
  public DifferentialDriveWheelSpeeds getSpeeds() {
    return new DifferentialDriveWheelSpeeds(
        canCoderLeftMaster.getVelocity() / kGearRatio * 2 * Math.PI * kWheelRadiusInches / 60,
        canCoderRightMaster.getVelocity() / kGearRatio * 2 * Math.PI * kWheelRadiusInches / 60
    );
  }
